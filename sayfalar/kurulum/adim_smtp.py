...
from ._yardimci import _alan, _sayi_alani, _aciklama, _degisince_hatayi_temizle
...
def smtp_adimini_olustur(stepper: ui.stepper, smtp_verisi: dict) -> None:
    with ui.step("E-posta (SMTP) Ayarları"):
        ...
        gonderen = _alan("Gönderici Adı *", "Lütfen Yanıtlamayınız")
        hata     = ui.label("").classes("text-negative text-caption")
        _degisince_hatayi_temizle(hata, sunucu, port, kullanici, sifre, gonderen)
